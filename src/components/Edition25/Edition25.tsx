        ...
        <section className="md:px-4 py-6">
            ...
            <main className="mt-15 ">
                ...
                <nav className="flex w-full md:flex-row flex-col my-15 justify-center items-center gap-5 md:gap-10">
                    <Button title="Apply Now" style={"bg-[#F06621] hover:bg-[#F6A37A] w-full md:w-1/2 py-4"} link="https://docs.google.com/forms/d/e/1FAIpQLSdHQ-J0ih1bjnUUzYpSUiodp5dwA8l4Edr7QInKTxdY_QuJhA/viewform?usp=header" newTab/>
                    <Button title="Download Full Program Brochure" style={"bg-black hover:bg-[#4B3D34] w-full md:w-1/2 py-4"} downloadLink="/brochure.pdf"/>
                </nav>
            </main>
        </section>
    )
