    ...
    return (
        <section className="">
            <main className="hero-bg text-white">
                ...
                <Button title="Apply Now for 2025" style={"bg-[#F06621] hover:bg-[#F6A37A] md:mt-5 md:px-11 md:py-4 px-7 py-3"} link="https://docs.google.com/forms/d/e/1FAIpQLSdHQ-J0ih1bjnUUzYpSUiodp5dwA8l4Edr7QInKTxdY_QuJhA/viewform?usp=header" newTab/>
            </main>
            <main className="py:5 md:py-15 flex flex-col md:flex-row text-center md:text-start">
                ...
                <article className="md:w-2/5 flex flex-col justify-between items-end">
                    ...
                    <div className="flex flex-col md:flex-row justify-between md:w-[95%] w-full">
                        <Button title="Apply Now for 2025" style={"bg-[#F06621] hover:bg-[#F6A37A] px-11 py-4 my-7 md:my-0"} link="https://docs.google.com/forms/d/e/1FAIpQLSdHQ-J0ih1bjnUUzYpSUiodp5dwA8l4Edr7QInKTxdY_QuJhA/viewform?usp=header" newTab/>
                        <Button title="Partner With us" style={"bg-black hover:bg-[#4B3D34] px-11 py-4"} link="https://docs.google.com/forms/d/e/1FAIpQLSc51CdFXa605Vsxpu-CuqaJ-OKsPfMoO9jh16QafdH7r6JiNQ/viewform?usp=header" newTab/>
                    </div>
                </article>
            </main>
        </section>
