    ...
    return (
        <section>
            <main className="hero-bg text-white">
                <h1 className="text-6xl font-grey-300 ">The Pivot Challenge</h1>
                <p className="text-md mt-3">Empowering MSMEs to Go Digital, Grow Stronger, and Get Seen.</p>
            </main>
            <main className="py-15 flex flex-row ">
                <article className="w-3/5">
                    <h2 className="text-4xl w-[72%] font-black">A Challenge. A Community. A Comeback Story for Local Businesses.</h2>
                ...
                <article className="w-2/5 flex flex-col justify-between items-end">
                    ...
                    <div className="flex flex-row justify-between w-[95%]">
                        <Button title="Apply Now for 2025" style={"bg-[#F06621] hover:bg-black "}/>
                        <Button title="Partner With us" style={"bg-black hover:bg-[#F06621] "}/>
                    </div>
                </article>
            </main>
        </section>
