...
export const RolePlay = () => {
 return (
    <section className="my-25 text-center">
        ...
        <main className="flex gap-5 justify-between mt-15">
            <article className="w-1/3 px-15">
                ...
                <Button title="Partner With Us" style={"bg-[#F06621] hover:bg-black px-10 py-4 mt-5"}/>
            ...
            <article className="w-1/3 px-15">
                ...
                <Button title="Join Our Mentor Network" style={"bg-[#F06621] hover:bg-black px-5 py-4 mt-5"}/>

            </article>

            <article className="w-1/3 px-10">
                ...
                <Button title="Become a Volunteer" style={"bg-[#F06621] hover:bg-black px-5 py-4 mt-5"}/>
            </article>
        </main>
    </section>
 )
