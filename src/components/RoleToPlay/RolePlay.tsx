  ...
  return (
    <section className="my-25 text-center">
      ...
      <main className="flex md:flex-row flex-col gap-15 justify-between mt-15">
        <article className="md:w-1/3 md:px-15 flex flex-col justify-between">
          <h1 className="text-xl font-bold">Partners & Donors</h1>
          <p className="mt-5 text-xl text-[#202020]">
            Want to sponsor an MSME, fund tech kits, or support connectivity?
        ...
        <article className="md:w-1/3 md:px-15 flex flex-col justify-between">
          ...
          <p className="mt-5 text-xl text-[#202020]">
            Have digital expertise? Share your knowledge and mentor the next
            generation of African business owners.
          </p>
          <br />
          {/* <br /> */}
          <div>
            <Button
              ...
              style={"bg-[#F06621] hover:bg-[#F6A37A] px-5 py-4 mt-5"}
              link="https://docs.google.com/forms/d/e/1FAIpQLSeQ-i6WRhEXs-RTMpUD6pjDK-x428MYWKC1iFjz4rZ62GgO3Q/viewform?usp=header"
                newTab
            />
          </div>
        </article>

        <article className="md:w-1/3 md:px-10 flex flex-col justify-between">
          <h1 className="text-xl font-bold">Volunteers</h1>
          <p className="mt-5 text-xl text-[#202020]">
            Passionate about small businesses? Come help us run smooth events,
          ...
          <div>
            <Button
              ...
              style={"bg-[#F06621] hover:bg-[#F6A37A] px-5 py-4"}
              newTab
