export const Stories = () => {
    return (
        <section className="my-15 text-center">
            ...
            <main className="my-15 flex flex-col gap-5">
                <div className="flex gap-5 w-full">
                    ...
                    <div className="w-1/3 h-[400px] overflow-hidden flex flex-col gap-5" >
                        <div className="h-1/2 overflow-hidden">
                            <img src="images/story2.jpg" alt="" className="w-full h-full object-cover rounded-2xl"/>
                        </div>
                        <div className="h-1/2 overflow-hidden">
                            <img src="images/story3.jpg" alt="" className="w-full h-full  object-cover rounded-2xl"/>
                        </div>
                    </div>
                </div>
                <div className="flex gap-5">
                    ...
                    <div className="w-2/3 h-[400px] overflow-hidden">
                        <img src="images/story5.jpg" alt="" className="w-full h-full object-cover rounded-2xl"/>
                    </div>
                </div>
            </main>
        </section>
